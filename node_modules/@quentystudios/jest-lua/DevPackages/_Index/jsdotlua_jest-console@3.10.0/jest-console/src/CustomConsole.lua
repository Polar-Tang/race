...
local Console = require(script.Parent:WaitForChild('Console')).default
...
local helpersModule = require(script.Parent:WaitForChild('helpers'))
...
local JestUtil = require(script.Parent.Parent:WaitForChild('jest-util'))
