...
local ConfigModule = require(script:WaitForChild('Config'))
...
local GlobalModule = require(script:WaitForChild('Global'))
...
local TestResultModule = require(script:WaitForChild('TestResult'))
...
local TransformModule = require(script:WaitForChild('Transform'))
