...
local NIL = require(script.Parent:WaitForChild('nilPlaceholder'))
...
local convertArrayTable = require(script.Parent:WaitForChild('table'):WaitForChild('array')).default
local convertTemplateTable = require(script.Parent:WaitForChild('table'):WaitForChild('template')).default
local validationModule = require(script.Parent:WaitForChild('validation'))
