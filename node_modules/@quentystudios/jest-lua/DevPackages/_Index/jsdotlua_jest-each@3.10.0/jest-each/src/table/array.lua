...
local format = require(script.Parent:WaitForChild('format'))-- ROBLOX deviation END
...
local pretty = require(script.Parent.Parent.Parent:WaitForChild('pretty-format')).format
...
local interpolationModule = require(script.Parent:WaitForChild('interpolation'))
