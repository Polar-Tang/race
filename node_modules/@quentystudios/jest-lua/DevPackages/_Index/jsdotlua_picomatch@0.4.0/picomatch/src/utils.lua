...
local win32 = false
local Constants = require(script.Parent:WaitForChild('constants'))-- ROBLOX TODO START: implement missing RegExp when 'g' flag available (or reimplement without RegExp)
...
local String_replace = require(script.Parent:WaitForChild('stringUtils')).stringReplace
