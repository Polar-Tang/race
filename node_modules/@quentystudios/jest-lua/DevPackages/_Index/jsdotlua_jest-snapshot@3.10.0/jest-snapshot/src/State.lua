...
local JestTypes = require(script.Parent.Parent:WaitForChild('jest-types'))-- ROBLOX deviation: custom type
...
local PrettyFormat = require(script.Parent:WaitForChild('PrettyFormat'))
...
local types = require(script.Parent:WaitForChild('types'))-- ROBLOX deviation: we do not have the BabelTraverse or Prettier types defined in the
-- types file
