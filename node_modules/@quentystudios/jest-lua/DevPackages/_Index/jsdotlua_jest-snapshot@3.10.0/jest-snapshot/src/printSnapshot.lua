...
local chalk = (require(script.Parent.Parent:WaitForChild('chalk')):: any) :: Chalk

local getObjectSubset = require(script.Parent.Parent:WaitForChild('jest-roblox-shared')).expect.getObjectSubset

local JestDiff = require(script.Parent.Parent:WaitForChild('jest-diff'))
...
local prettyFormat = require(script.Parent.Parent:WaitForChild('pretty-format')).format
