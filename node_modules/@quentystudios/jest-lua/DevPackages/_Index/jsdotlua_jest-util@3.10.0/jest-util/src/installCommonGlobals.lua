...
type Config_ConfigGlobals = typesModule.Config_ConfigGlobals
	local createProcessObject = require(script.Parent:WaitForChild('createProcessObject')).default
	local deepCyclicCopy = require(script.Parent:WaitForChild('deepCyclicCopy')).default
