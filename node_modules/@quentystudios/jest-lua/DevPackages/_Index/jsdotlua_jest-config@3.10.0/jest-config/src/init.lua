...
local chalk = require(script.Parent:WaitForChild('chalk'))-- ROBLOX deviation START: not needed
...
local normalize = require(script:WaitForChild('normalize')).default
local readConfigFileAndSetRootDir = require(script:WaitForChild('readConfigFileAndSetRootDir')).default
local resolveConfigPath = require(script:WaitForChild('resolveConfigPath')).default
...
-- ROBLOX deviation END
exports.isJSONString = require(script:WaitForChild('utils')).isJSONString
exports.normalize = require(script:WaitForChild('normalize')).default
-- ROBLOX deviation START: not needed
-- exports.deprecationEntries = require("./Deprecated").default
-- exports.replaceRootDirInPath = require("./utils").replaceRootDirInPath
-- ROBLOX deviation END
exports.defaults = require(script:WaitForChild('Defaults')).default
-- ROBLOX deviation START: not needed
...
local RobloxShared = require(script.Parent:WaitForChild('jest-roblox-shared'))
