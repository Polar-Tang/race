...
-- ROBLOX deviation END
local DEFAULT_CONFIG = require(script.Parent:WaitForChild('Defaults')).default
-- ROBLOX deviation START: not used
...
-- ROBLOX deviation END
local getMaxWorkers = require(script.Parent:WaitForChild('getMaxWorkers')).default
...
-- ROBLOX deviation END
local setFromArgv = require(script.Parent:WaitForChild('setFromArgv')).default
...
-- ROBLOX deviation END
local validatePattern = require(script.Parent:WaitForChild('validatePattern')).default
...
key == "setupFiles" or key == "setupFilesAfterEnv" or key == "snapshotSerializers" then
					do
