...
local Types = require(script.Parent:WaitForChild('types'))-- ROBLOX TODO: import correct types
...
export type AsymmetricMatcher<T> = {
	...
	toString: (self: AsymmetricMatcher<T>) -> string,
	getExpectedType: (self: AsymmetricMatcher<T>) -> string,
	toAsymmetricMatcher: (self: AsymmetricMatcher<T>) -> string	-- ROBLOX deviation END
...
type AsymmetricMatcher_private<T> = { --
	...
	getMatcherContext: (self: AsymmetricMatcher_private<T>) -> MatcherState	-- ROBLOX deviation END
...
function Any.new(sample: any)
	if typeof(sample) ~= "table" and typeof(sample) ~= "string" then
		error(
[[any() expects to be passed a typename string or a prototype class. Please pass one or use anything() to match any object.]]		
