...
local testResultModule = require(script.Parent.Parent:WaitForChild('jest-test-result'))
...
local jestMessageUtilModule = require(script.Parent.Parent:WaitForChild('jest-message-util'))
...
local jestUtilModule = require(script.Parent.Parent:WaitForChild('jest-util'))
local clearLine = jestUtilModule.clearLine

local BaseReporter = require(script.Parent:WaitForChild('BaseReporter')).default
local statusModule = require(script.Parent:WaitForChild('Status'))
local Status = statusModule.default
type Status = statusModule.Status
local getResultHeader = require(script.Parent:WaitForChild('getResultHeader')).default
local getSnapshotStatus = require(script.Parent:WaitForChild('getSnapshotStatus')).default
